...
create table public.game_table_assignments (
  id uuid primary key default gen_random_uuid(),
...
create table public.venue_players (
  id uuid primary key default gen_random_uuid(),
...
alter publication supabase_realtime add table public.game_clocks;
alter publication supabase_realtime add table public.game_table_assignments;
alter publication supabase_realtime add table public.seats;
alter publication supabase_realtime add table public.venue_players;
